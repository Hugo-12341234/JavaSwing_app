...
/**
 * Contient les d�clarations de constantes globales pour le projet des 
 * disjoncteurs.
 * 
...
public class Constantes {
	...
	public static final String 
		OPT_SAUVEGARDER= "Sauvegarder une bo�te";
	
	public static final String OPT_RECUPERER= "R�cup�rer une bo�te";
